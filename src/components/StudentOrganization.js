        ...
        >
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-4">
            <button
              ...
              onClick={() =>
                openImage(
                  `${process.env.PUBLIC_URL}/DSC_4387.webp`,
                  "CSA CTF Event"
                )
              }
            >
            ...
            <button
              ...
              onClick={() =>
                openImage(
                  `${process.env.PUBLIC_URL}/WhatsApp Image 2025-08-22 at 5.54.59 PM (3).jpeg`,
                  "CSA Event"
                )
              }
            >
            ...
            <button
              ...
              onClick={() =>
                openImage(
                  `${process.env.PUBLIC_URL}/WhatsApp Image 2025-10-15 at 6.52.00 PM (1).jpeg`,
                  "CSA Workshop"
                )
              }
            >
        ...
        >
          <div className="grid lg:grid-cols-[1fr_160px] gap-6 items-start">
            ...
            <div>
              ...
              <p className="mt-3 max-w-3xl text-slate-700 dark:text-slate-300 leading-relaxed">
                ...
                &ensp;focusing on research related to Automotive Ethernet cybersecurity
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-4">
            <button
              type="button"
              onClick={() =>
                openImage(`${process.env.PUBLIC_URL}/Screenshot 2026-03-07 at 11.27.37 PM.png`,
                  "ISSF Poster"
                )
              }
            >
            ...
            <button
              ...
              onClick={() =>
                openImage(
                  `${process.env.PUBLIC_URL}/Screenshot 2026-03-07 at 11.29.04 PM.png`,
                  "ISSF Lab"
                )
              }
            >
            ...
            <button
              ...
              onClick={() =>
                openImage(
                  `${process.env.PUBLIC_URL}/Japan professor_2.jpg`,
                  "ISSF Research"
                )
              }
            >
